...
public class DictionaryConstant {
    ...
    /**
     * CaCarGps 中安装方式 InstallWay
     * @author 石冬冬
     */
    public enum CarGpsInstallWayEnum implements EnumValue {
        ...
        CarGpsInstallWayEnum(int index, String name) {
            this.index = index;
            this.name = name;
        }
        ...
        public static String getNameByIndex(int index){
            for(CarGpsInstallWayEnum e : CarGpsInstallWayEnum.values()){
                if(e.getIndex() == index){
                    return e.getName();
                }
            }
        ...
        public static CarGpsInstallWayEnum getByIndex(int index){
            for(CarGpsInstallWayEnum e : CarGpsInstallWayEnum.values()){
                if(e.getIndex() == index){
                    return e;
                }
